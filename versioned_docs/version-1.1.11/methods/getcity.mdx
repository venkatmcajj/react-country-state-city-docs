...
:::info
The `GetCity` function in react-country-state-city fetches a list of [**city**](/docs/types/city) objects based on given country and state id's. The async function returns an array of [**city**](/docs/types/city) objects, each containing details such as name, latitude and longitude.
:::
...
Returns a [**city**](/docs/types/city) object lists.
