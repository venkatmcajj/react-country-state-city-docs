...
:::info
The `GetLanguages` function in react-country-state-city fetches a list of [**language**](/docs/types/language) objects. The async function returns an array of [**language**](/docs/types/language) objects, each containing details such as name, code, and native.
:::
...
Returns a [**language**](/docs/types/language) object lists.
