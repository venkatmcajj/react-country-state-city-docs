...
:::info
The `GetState` function in react-country-state-city fetches a list of [**state**](/docs/types/state) objects based on given country id. The async function returns an array of [**state**](/docs/types/state) objects, each containing details such as name and code.
:::
...
Returns a [**state**](/docs/types/state) object lists.
