...
function Countrybyregionmethods() {
  const rows = [
    {
      title: "id",
      type: "number",
        ...
        >
          ...
          >
            ...
            <Typography variant="body2">
              The GetCountriesByRegion function in react-country-state-city fetches a
              list of country objects within the given region. The async function returns an array of
          ...
          <Grid sx={{display:'flex'}}>
            <Button to="/get-phonecodes" component={Link} variant="outlined" startIcon={<ArrowLeft />}>GetPhonecodes</Button>
            <Button  component={Link} sx={{ml:'auto'}} to="/get-phonecodes-by-region" variant="outlined"  endIcon={<ArrowRight />}>GetPhonecodesByRegion</Button>
          </Grid>
        </Grid>
      </Grid>
    </Grid>
...
export default Countrybyregionmethods;
