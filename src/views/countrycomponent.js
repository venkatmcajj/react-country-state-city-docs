    ...
    <Grid item xs={12}>
      <Grid container spacing={3}>
        <Breadcrumbs aria-label="breadcrumb" mx={5} mt={5}>
          ...
          <Typography sx={{ color: "text.primary" }}>Country Select</Typography>
        </Breadcrumbs>
        <Grid
          component={Paper}
          item
        ...
        >
          ...
          <Box sx={{ height: 16 }} />
          <Typography variant={"label"} mt={2}>
            Description: The region prop is used to filter and display only the countries that belong to a specific region.
          </Typography>
          <Divider sx={{my:2}} />
          ...
          <Box sx={{ height: 16 }} />
          <Typography variant={"label"} mt={2}>
            Description: The current value: a country object
          </Typography>
          <Divider sx={{my:2}} />
          ...
          <Box sx={{ height: 16 }} />
          <Typography variant={"label"} mt={2}>
            Description: The current value: a country object.The argument is the country object
          </Typography>
          <Divider sx={{my:2}} />
          ...
          <Box sx={{ height: 16 }} />
          <Typography variant={"label"} mt={2}>
            Description: Flags are displayed when true and not displayed when false. default is true.
          </Typography>
          <Divider sx={{my:2}} />
          <Grid sx={{display:'flex'}}>
            <Button to="/" component={Link} variant="outlined" startIcon={<ArrowLeft />}>Getting Started</Button>
            <Button  component={Link} sx={{ml:'auto'}} to="/state-select" variant="outlined"  endIcon={<ArrowRight />}>State Select</Button>
          </Grid>
        </Grid>
      </Grid>
    </Grid>
